...
export function LeadsClient() {
  ...
  return (
    <div className="container-tight section">
      ...
      {!configured && (
        <div className="surface rounded-xl p-4 text-sm text-ink-muted mb-4">
          ⚠ Supabase غير مهيأ. اضبط <code className="text-accent">NEXT_PUBLIC_SUPABASE_URL</code>{' '}
          و <code className="text-accent">SUPABASE_SERVICE_ROLE_KEY</code> في ملف{' '}
