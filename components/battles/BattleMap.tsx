      ...
      <svg viewBox="0 0 100 100" className="absolute inset-0 h-full w-full">
        <defs>
          <radialGradient id="mapFill" cx="50%" cy="50%" r="60%">
            <stop offset="0%" stopColor="rgba(255,50,0,0.08)" />
          ...
          return (
            <g key={b.id}>
              <motion.circle
                ...
                cy={b.pin.y}
                r={isActive ? 4 : 3}
                fill={isActive ? 'rgba(255,138,61,0.25)' : 'rgba(255,50,0,0.18)'}
                animate={
                  isActive
                    ? { r: [3, 5, 3] }
                    : { r: [2.6, 3.4, 2.6] }
              ...
              <text
                ...
                y={b.pin.y + 0.5}
                fontSize="2.4"
                fill={isActive ? '#FFB070' : 'rgba(255,255,255,0.85)'}
                onClick={() => onSelect(b.id)}
